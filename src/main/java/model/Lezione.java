...
public class Lezione {
    ...
    public Lezione(Insegnamento insegnamento, String giornoSettimana, LocalTime oraInizio,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(insegnamento, giornoSettimana, oraInizio);
    }

    @Override
    public String toString() {
        return insegnamento.getNome() + " - " + giornoSettimana + " " + oraInizio + "-" + oraFine;
    }
}
